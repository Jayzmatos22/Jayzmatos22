...
### 👨‍💻 Sobre Mim
Jailton Santos, 23 anos. **Desenvolvedor Backend (e full stack) Júnior em formação**, focado em construir sistemas robustos e escaláveis. Curso ADS há 8 MESES, focando em domínio de lógica POO, usando Python, Java Spring Boot, Javascript, html, css e Tailwind.
...
* 📊 **[Nexus Academy ERP](https://github.com/Jayzmatos22/Nexus-Academy-ERP)** <br>
  <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" /> <img src="https://img.shields.io/badge/Data_Analysis-150458?style=flat-square&logo=pandas&logoColor=white" /><br>
  **O que é:** ERP Acadêmico & Financeiro modular com recursos de análise de dados.<br>
  **Destaque Técnico:** Lógica de negócios complexa aplicada à gestão educacional e financeira.

* 🥬 **[FridgeSistem (Spring Boot JPA)](https://github.com/Jayzmatos22/Spring-Boot-Jpa-fridge)** <br>
  <img src="https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white" /> <img src="https://img.shields.io/badge/Spring_Data_JPA-6DB33F?style=flat-square&logo=spring&logoColor=white" /> <img src="https://img.shields.io/badge/H2_Database-4479A1?style=flat-square&logo=databricks&logoColor=white" /><br>
  **O que é:** API de gerenciamento de estoque focado em armazenamento (geladeira).<br>
  **Destaque Técnico:** Uso de banco de dados em memória (H2) para testes ágeis e mapeamento objeto-relacional (ORM).
...
* 📦 **[Inventário Pro (InvPro)](https://github.com/Jayzmatos22/Invent-rio-Pro-front-end-js)** <br>
  ...
  **Destaque Técnico:** Manipulação dinâmica do DOM, componentização visual com Tailwind e persistência local via `LocalStorage`.

* 🎬 **[Netflix Page Login](https://github.com/Jayzmatos22/login-Netflix-page)** <br>
